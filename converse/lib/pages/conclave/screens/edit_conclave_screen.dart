...
class _EditConclaveScreenState extends ConsumerState<EditConclaveScreen> {
  ...
  Uint8List? bannerWebFile, displayPicWebFile;
  ...
  void selectDisplayPicImage() async {
    ...
    if (res != null) {
      if (kIsWeb) {
        setState(() {
          displayPicWebFile = res.files.first.bytes;
        });
      } else {
        setState(() {
  ...
  void save(Conclave conclave) {
    ref.read(conclaveControllerProvider.notifier).editConclave(
          ...
          displayPicWebFile: displayPicWebFile,
        );
  }
                            ...
                            children: [
                              ...
                              Positioned(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: displayPicWebFile != null
                                      ? circleAvatar(
                                          backgroundImage:
                                              MemoryImage(displayPicWebFile!),
                                          radius: 35,
                                        )
                                      : displayPicFile != null
                                          ? circleAvatar(
